        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="text-sm text-[var(--muted-foreground)]">
              Descubre negocios verificados, aprovecha ofertas y comparte tus experiencias.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-[var(--muted-foreground)]">
              <li>
                <Link href="/negocios" className="hover:text-[var(--primary)]">Todos los negocios</Link>
              </li>
              <li>
                <Link href="/categories" className="hover:text-[var(--primary)]">Categorías</Link>
              </li>
              <li>
                <Link href="/offers" className="hover:text-[var(--primary)]">Ofertas disponibles</Link>
              </li>
              <li>
                <Link href="/business-requests" className="hover:text-[var(--primary)]">Registrar mi negocio</Link>
              </li>
            </ul>
          </div>
              ...
              <>
                ...
                <ul className="flex flex-wrap gap-2 text-sm text-[var(--muted-foreground)]">
                  {uniqueCities.map((city) => (
                    <li key={city}>
                      <Link
                        href={`/ciudad/${encodeURIComponent(city.toLowerCase().replace(/\s+/g, "-"))}`}
